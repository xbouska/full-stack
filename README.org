...
#+begin_src emacs-lisp :exports none 
  (setq
   ...
   (list '("lg-authors" "Authors" org-link-decode)
     ...
     '("learning_1" "Learn more:" identity)
...
https://youtu.be/8NzkYsY7TOk
YouTubeYouTube | DevOne
DevOneConf 2018 - Siren Hofvander - Making Security an integrated part of the SW Dev Lifecycle 
** WIP Books
...
** TODO Chaos Engineering
* WIP Commented sources                                            :CHAPTER:
...
#+begin_src elisp  :eval no
  (let ((org-propview-default-value "Not Yet Defined"))
    (org-propview-collect cols "%S" '((string-match "CONCEPT" TAGS)) nil '("README.org") nil colnames ))
#+end_src
