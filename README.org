...
#+RESULTS:
| learning | http://www.unicode.org/standard/WhatIsUnicode.html |
...
#+RESULTS:
| learning | https://www.openpolicyagent.org/docs/latest/                                                  |
| learning | https://www.se-radio.net/2020/04/episode-406-torin-sandall-on-distributed-policy-enforcement/ |
...
#+RESULTS:
| learning | https://blog.sonatype.com/principle-based-devops-frameworks-three-ways |
...
*** TODO Avoiding Microserv0ice Megadisasters - Jimmy Bogard
:PROPERTIES:
:lg-source: YouTube
