...
#+RESULTS:
| Primary source: | https://en.wikipedia.org/wiki/Comparison_of_data-serialization_formats |
...
** WIP Patterns: (Enterprise Architecture Integration Patterns) [0/4]
