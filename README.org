...
:PROPERTIES:
:learning_1: https://swagger.io/docs/specification/authentication/
:CUSTOM_ID: OAS_AUTHENTICATION
:END:
#+call: lg-get-props-entry()

**** TODO Basic Authentication
:PROPERTIES:
:CUSTOM_ID: OAS_BASIC_AUTHENTICATION
:END:
#+call: lg-get-props-entry()

**** TODO API Keys
:PROPERTIES:
:CUSTOM_ID: OAS_API_KEYS
:END:
#+call: lg-get-props-entry()

**** WIP Bearer Authentication
:PROPERTIES:
:learning_1: https://swagger.io/docs/specification/authentication/bearer-authentication/
:CUSTOM_ID: OAS_BEARER_AUTHENTICATION
:END:
#+call: lg-get-props-entry()
