...
#+begin_src elisp  :eval no
  (let ((org-propview-default-value "N/D"))
    (org-propview-collect cols "%S" '((boundp 'LG-SE-RADIO-URL)) nil '("README.org") nil colnames ))
#+end_src
