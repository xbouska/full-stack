...
*** TODO mantisa exponent jednickovy a dvojkovy doplnek
*** Endian
** TCP/IP
*** IP address / netmask
*** CIDR
...
:PROPERTIES:
:study: https://github.com/ahmetb/kubernetes-network-policy-recipes
:study: https://www.infoq.com/news/2019/12/network-isolation-kubernetes/
:END:
:ANSWER:
...
** CORS
:PROPERTIES:
:study: https://www.codecademy.com/articles/what-is-cors
:END:
...
** JWT
:PROPERTIES:
:study:    https://tools.ietf.org/html/rfc7519
:END:
