...
*** WIP GRASP
:PROPERTIES:
:learning_1: https://en.wikipedia.org/wiki/GRASP_(object-oriented_design)
:END:
#+call: lg-get-props-entry()
...
*** FantomJS                                                     :OUTDATED:
*** Protractor
* WIP Information Sources [0/6]                                      :DOMAIN:
:PROPERTIES:
...
*** Beauty in Code
** WIP Books
*** Gene Kim, Patrick Debois, John Willis, Jez Humble: The DevOps Handbook: How to Create World-Class Agility, Reliability, and Security in Technology Organizations :AUDIBLE:
...
*** Nassim Nicholas Taleb: Skin in the Game: Hidden Asymmetries in Daily Life :AUDIBLE:
Series: Incerto
...
*** Nassim Nicholas Taleb: Antifragile: Things That Gain from Disorder :AUDIBLE:
Series: Incerto
...
*** Nassim Nicholas Taleb: Fooled by Randomness: The Hidden Role of Chance in Life and in the Markets :AUDIBLE:
Series: Incerto
- This audiobook is about luck, or more precisely, how we perceive and deal with luck in life and business....

*** Nassim Nicholas Taleb: The Black Swan, Second Edition: The Impact of the Highly Improbable: :AUDIBLE:
...
*** Stuart Firestein: Failure: Why Science Is so Successful       :AUDIBLE:
...
*** Philip Tetlock , Dan Gardner: Superforecasting: The Art and Science of Prediction :AUDIBLE:
...
*** Barry O'Reilly: Unlearn: Let Go of Past Success to Achieve Extraordinary Results :AUDIBLE:
...
*** Andy Greenberg: Sandworm: A New Era of Cyberwar and the Hunt for the Kremlin's Most Dangerous Hackers :AUDIBLE:
...
*** Philip E. Tetlock: Expert Political Judgment: How Good is it? How can We Know? :AUDIBLE:
...
*** Steven Pinker: The Stuff of Thought: Language as a Window into Human Nature :AUDIBLE:
...
*** Simon Conway Morris (Editor): The Deep Structure of Biology: Is Convergence Sufficiently Ubiquitous to Give a Directional Signal :AUDIBLE:
...
*** Irvin D. Yalom: The Schopenhauer Cure: A Novel      :AUDIBLE:no_export:
...
:lg-authors: Linda%20Rising
:leadning_1:  https://vimeo.com/325143661
:END:
#+call: lg-get-props-entry()
...
- finally the code that was driving the engine in diesel gate was written by someone
  - -> this developer(s) knew what are they doing
  - 
** WIP ACM ethics Code 
:PROPERTIES:
:learning_1: https://ethics.acm.org/
:END:
* WIP Concepts [0/3]                                                 :DOMAIN:
:PROPERTIES:
:CUSTOM_ID: CONCEPTS
:END:
#+call: lg-get-props-entry()

** TODO Fat Tail Distribution                                        :TOPIC:
** TODO Data Driven Decision                                         :TOPIC:
** TODO Scepticism                                                   :TOPIC:
...
:ld-url: http://www.youarenotsosmart.com/
:END:
...
:header-args+: :noweb eval
:header-args+:  :var conds='true
:END:
#+name: collector
#+begin_src elisp :eval no
  (setq org-propview-default-value "-")
  (let ((org-propview-default-value ""))
    (org-propview-collect cols "%S" '((boundp 'LEARNING_1)) nil '("README.org") nil colnames ))
#+end_src
...
| Beyond CAP database systems                              | http://www.grokkingsystemdesigns.com/beyond-cap-theorem/                                                                                                     |
...
| CORS                                                     | https://www.codecademy.com/articles/what-is-cors                                                                                                             |
| Content Security Policy (CSP)                            | https://dev.to/ahmedatefae/web-security-knowledge-you-must-understand-it-part-i-https-tls-ssl-cors-csp-298l                                                  |
